...
gui.Frame.Frame.LoadFile.Activated:Connect(function()
	if isfile and isfile(gui.Frame.Frame.FileName.Text .. ".One") then
		--values = game:GetService("HttpService"):JSONDecode(readfile(gui.Frame.Frame.FileName.Text))
		local newvals = game:GetService("HttpService"):JSONDecode(readfile(gui.Frame.Frame.FileName.Text .. ".One"))
	...
	elseif isfile and isfile(gui.Frame.Frame.FileName.Text) then
...
gui.Frame.Frame.Convert.Activated:Connect(function()
	...
	print(values["Right Arm"]["X"],values["Right Arm"]["Y"],values["Right Arm"]["Z"]) 
